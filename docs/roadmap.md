...
- **Image Generation (Imagen)**: Support for generating images using the Imagen models.
- **Files API Support**: Comprehensive support for the Gemini Files API (upload, list, delete files).
- **Audio and Video Support**: Helper methods and examples for handling audio and video inputs.
